...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes an optional int argument.
    # When no argument is given, the first and second elements of the array
    # are taken as the first and second values which need to be populated
    # within the block. (sum and item)
    # When an argument is given, the argument populates the first value in
    # the block and the first element of the array populates the second value
    # in the block.
  end
